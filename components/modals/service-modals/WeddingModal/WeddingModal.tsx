    ...
    <>
      ...
      <article className={styles.event}>
        ...
        <p className={styles.eventDesc}>
          ...
          Катерина - саме такі. Коли вона каже: «Креветки у вершковому соусі?
          він завжди «за». Коли він сідає за PlayStation, вона поруч, навіть
          якщо не грає. Просто тому, що разом - це краще Він любить азарт і
          пригоди: авторинок, історичні знахідки і, риболовлю. Вона підтримує
          його захоплення, навіть якщо сама не бере до рук вудку. Бо розуміє: у
          кожного має бути власна стихія. За час разом вони навчилися мріяти
          спільно. Їхнє весілля було саме таким - щирим, теплим і дуже «їхнім».
          Без зайвого шуму, але зі справжніми емоціями.
        </p>
