    ...
    <>
      ...
      <article className={styles.event}>
        ...
        <p className={styles.eventDesc}>
          День народження у Ірини, до неї прийшло багато людей: друзі, родина,
          ті, хто поважає, любить і цінує її. Вона відкрита, щира, впевнена та
          цілеспрямована людина. І це відчувається в усьому, навіть у тому, як
          пройшов її день народження.
        </p>
      ...
      <article className={styles.event}>
        ...
        <p className={styles.eventDesc}>
          Моя улюблена кондитерська де я провів корпоратив. Морквяна Марʼяна
          місце, де я часто зустрічаюся із замовниками й друзями, де просто
          приємно провести час. Мережа відзначала корпоратив, і десятиріччя
          своєї компанії. Це був яскравий відпочинок і ювілейний день мережі
          кондитерських, яку полюбили рівняни та гості нашого міста.
        </p>
      ...
      <article className={styles.event}>
        ...
        <p className={styles.eventDesc}>
          Якщо краса - це сила, то цей форум був справжнім епіцентром енергії!!
          Дякую за довіру бути частиною @bebeauty_top100 як ведучий. Атмосфера,
          стиль, драйв - усе як треба!
        </p>
      ...
      <article className={styles.event}>
        ...
        <p className={styles.eventDesc}>
          Перший рік життя Юстинки зібрав тих, хто вже її любить назавжди Радію,
          що був частиною цього особливого дня. Сімʼя, друзі, хресні, обійми,
          щирі слова, дитячий сміх.
        </p>
      ...
      <article className={styles.event}>
        ...
        <p className={styles.eventDesc}>
          Яскравий літній корпоратив, Просто ще одна гарно зроблена справа.
        </p>
