  ...
  return (
    <>
      ...
      <article className={styles.event}>
        ...
        <p className={styles.eventDesc}>
          Ми стали свідками події, що обʼєднала лідерів бізнесу, прогресивних
          освітян та візіонерів технологічного сектору. Це був не просто обмін
          досвідом, а справжня синергія смислів, де народжуються рішення, що
          визначатимуть вектор розвитку нашої країни на роки вперед. Для мене
          було великою честю та відповідальністю стати голосом цього заходу.
          Роль ведучого на такій масштабній платформі — це не лише про мікрофон
          у руках, а про можливість першим відчути пульс інновацій. Це важливий
          крок, який дарує колосальну мотивацію рухатися далі та
          вдосконалюватися. Два дні, що змінили сприйняття, глибокі дискусії:
          від етики ШІ до його практичного впровадження у виробничі процеси.
          Нетворкінг: знайомства, які переростають у стратегічне партнерство.
          Атмосфера: простір, де майбутнє створюється тут і зараз. Вдячний
          кожному учаснику за енергію та команді організаторів — за довіру.
          Продовжуємо творити нову історію разом!
        </p>
