...
const faqs = [
  {
    id: 1,
    question: "Які саме події ви проводите?",
    answer:
      "• Приватні свята: весілля, дні народження, гендер-паті, хрещення та рочок дитини\n• Корпоративні заходи та відкриття магазинів/бізнесів\n• Ділові події: презентації, конференції та форуми\n• Масштабні проєкти: концерти та благодійні заходи",
  },
  {
    id: 2,
