...
const facts = [
  "+100 проведений заходів, різного формату та масштабу",
  ...
  "Відкритий до новий ідей трендів, втілимо це у ваш день",
        ...
        <div className={`${styles.row} ${styles.rowImageLeft}`}>
          ...
          <div className={styles.textBlock}>
            <p className={styles.lead}>
              Професійний ведучий із режисерською освітою. Органічно поєдную
